...
## and arrow-key navigation through a group of images.
...
func _load_current_image() -> void:
	...
	_filename_label.add_theme_font_override("font", GameManager.font_title)
...
# ===================================================================
# Hint bar (bottom-right) — reused KeyHintBar visual style
# ===================================================================
...
func _setup_hint_bar() -> void:
	...
	_hint_prev_label.add_theme_font_override("font", GameManager.font_title)
	...
	_hint_prev_text.add_theme_font_override("font", GameManager.font_body)
	...
	_hint_next_label.add_theme_font_override("font", GameManager.font_title)
	...
	_hint_next_text.add_theme_font_override("font", GameManager.font_body)
	...
	_hint_esc_label.add_theme_font_override("font", GameManager.font_title)
	...
	_hint_esc_text.add_theme_font_override("font", GameManager.font_body)
